namespace CloudGarage.Inventory {
    export namespace PermissionKeys {
        ...
        namespace Transfers {
            export const View = "Inventory:Transfers:View";
            export const Create = "Inventory:Transfers:Create";
            export const Update = "Inventory:Transfers:Update";
            export const Delete = "Inventory:Transfers:Delete";
        }
    }
}
