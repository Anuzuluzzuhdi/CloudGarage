namespace CloudGarage.invoice {
    export interface PickerJobItemForm {
    ...
    export class PickerJobItemForm extends Serenity.PrefixedContext {
        ...
        constructor(prefix: string) {
            ...
            if (!PickerJobItemForm.init)  {
                PickerJobItemForm.init = true;
                ...
                Q.initFormType(PickerJobItemForm, [
                    'CustomerId', w0,
                    'Date', w1,
                    'PaymentAccount', w0,
                    'GrandTotal', w2,
