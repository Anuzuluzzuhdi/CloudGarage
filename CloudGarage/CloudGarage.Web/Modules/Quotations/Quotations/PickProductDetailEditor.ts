namespace CloudGarage.Quotations {
    ...
    @Serenity.Decorators.registerEditor('CloudGarage.Quotations.PickProductDetailEditor')
    export class PickProductDetailEditor extends Serenity.Extensions.GridEditorBase<QuotationdetailsRow> {
