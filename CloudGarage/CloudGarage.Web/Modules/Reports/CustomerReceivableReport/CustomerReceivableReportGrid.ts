...
namespace CloudGarage.Reports {
    ...
    export class CustomerReceivableReportGrid extends Serenity.EntityGrid<BusinessPartners.CustomersRow, any> {
        protected getColumnsKey() { return 'Reports.CustomerReceivableReport'; }
        protected getDialogType() { return BusinessPartners.CustomersDialog; }
        protected getIdProperty() { return BusinessPartners.CustomersRow.idProperty; }
        protected getInsertPermission() { return BusinessPartners.CustomersRow.insertPermission; }
        protected getLocalTextPrefix() { return BusinessPartners.CustomersRow.localTextPrefix; }
        protected getService() { return BusinessPartners.CustomersService.baseUrl; }
