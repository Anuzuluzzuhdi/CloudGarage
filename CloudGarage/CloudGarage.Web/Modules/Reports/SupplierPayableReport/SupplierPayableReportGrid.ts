...
namespace CloudGarage.Reports {
    ...
    export class SupplierPayableReportGrid extends Serenity.EntityGrid<BusinessPartners.SuppliersRow, any> {
        protected getColumnsKey() { return 'Reports.SupplierPayableReport'; }
        protected getDialogType() { return BusinessPartners.SuppliersDialog; }
        protected getIdProperty() { return BusinessPartners.SuppliersRow.idProperty; }
        protected getInsertPermission() { return BusinessPartners.SuppliersRow.insertPermission; }
        protected getLocalTextPrefix() { return BusinessPartners.SuppliersRow.localTextPrefix; }
        protected getService() { return BusinessPartners.SuppliersService.baseUrl; }
