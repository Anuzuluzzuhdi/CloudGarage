...
namespace CloudGarage.Purchasing {
    ...
    export class PurchaseDetailEditor extends Serenity.Extensions.GridEditorBase<PurchasedetailsRow> {
        protected getColumnsKey() { return "Purchasing.Purchasedetails"; }
