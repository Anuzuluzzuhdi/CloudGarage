namespace CloudGarage.Purchasing {
    ...
    @Serenity.Decorators.registerEditor('CloudGarage.Purchasing.PickerProductDetailsEditor')
    export class PickerOrderDetailsEditor1 extends Serenity.Extensions.GridEditorBase<PurchasedetailsRow> {
                        ...
                        dlg.onSuccess = (selected) => {
                            ...
                            for (var sel of selected) {
                                var item = <PurchasedetailsRow>{
                                    ...
                                    Description: sel.BrandDescription,
