...
using CloudGarage.Web.Modules.Administration.Role;
...
using MyRow = CloudGarage.Administration.UserPermissionRow;

namespace CloudGarage.Administration.Repositories
{
