...
{
    [ConnectionKey("couldgarage"), Module("Financial"), TableName("debitvoucher")]
    [DisplayName("Debitvoucher"), InstanceName("Debitvoucher")]
    ...
    public sealed class DebitvoucherRow : Row<DebitvoucherRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Credit Account Head"), NotNull, ForeignKey("accounts", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        ...
        [NotMapped]
        [DisplayName("Account"), NotNull, ForeignKey("accounts", "Id"), LeftJoin("jCoaDebit"), TextualField("CoaHeadName")]
        [LookupInclude, LookupEditor(typeof(AccountsRow), AutoComplete = true)]
        public int? DebitAccountId
        {
            get => fields.DebitAccountId[this];
