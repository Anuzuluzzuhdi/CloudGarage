...
{
    [LookupScript]
    public class AccountsCustomerLookup : AllBranchRowLookupScript<AccountsRow>
    {
        public AccountsCustomerLookup(ISqlConnections connections, IUserAccessor userAccessor, IUserRetrieveService userRetriever, ITwoLevelCache cache) : base(connections, userAccessor, userRetriever, cache)
        {                                                                                                                   
