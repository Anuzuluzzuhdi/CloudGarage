...
{
    [ConnectionKey("couldgarage"), Module("Financial"), TableName("creditvoucher")]
    [DisplayName("Creditvoucher"), InstanceName("Creditvoucher")]
    ...
    public sealed class CreditvoucherRow : Row<CreditvoucherRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Debit Account Head"), NotNull, ForeignKey("accounts", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        ...
        [DisplayName("Account"), NotNull, ForeignKey("accounts", "Id"), LeftJoin("jCoaCredit"), TextualField("CoaHeadName")]
        [LookupInclude, LookupEditor(typeof(AccountsRow), AutoComplete = true), NotMapped]
        public int? CreditAccountId
        {
            get => fields.CreditAccountId[this];
