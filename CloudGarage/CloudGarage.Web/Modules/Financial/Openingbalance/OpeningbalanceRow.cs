...
{
    [ConnectionKey("couldgarage"), Module("Financial"), TableName("openingbalance")]
    [DisplayName("Openingbalance"), InstanceName("Openingbalance")]
    ...
    public sealed class OpeningbalanceRow : Row<OpeningbalanceRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("V No"), Size(255), QuickSearch, NameProperty]
        public string VNo
        {
            get => fields.VNo[this];
        ...
        [DisplayName("Account Head"), NotNull, ForeignKey("accounts", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        [LookupInclude, LookupEditor(typeof(AccountsLookup), AutoComplete = true)]
        public int? CoaId
        {
