    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your CloudGarage Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your CloudGarage Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "CloudGarage";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText FooterCopyright = "Copyright (c) 2015 - 2021.";
