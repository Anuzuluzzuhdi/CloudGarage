...
{
    [ConnectionKey("couldgarage"), Module("CashBank"), TableName("cashadjustment")]
    [DisplayName("Cash Adjustment"), InstanceName("Cashadjustment")]
    ...
    public sealed class CashadjustmentRow : Row<CashadjustmentRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Coa"), ForeignKey("accounts", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        ...
        [DisplayName("Remark"), Size(255), NotNull]
