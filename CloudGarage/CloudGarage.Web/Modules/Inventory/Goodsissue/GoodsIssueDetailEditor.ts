...
namespace CloudGarage.Inventory{
    ...
    export class GoodsIssueDetailEditor extends Serenity.Extensions.GridEditorBase<Inventory.GoodsissuedetailsRow> {
        protected getColumnsKey() { return "Inventory.Goodsissuedetails"; }
        protected getLocalTextPrefix() { return Inventory.GoodsissuedetailsRow.localTextPrefix; }
        ...
        private saveClick() {
            ...
            (function saveNext() {
                ...
                entity.Id = key;
                Q.serviceRequest(GoodsissuedetailsService.Methods.Update, {
                    EntityId: key,
                    Entity: entity
                }, (response) => {
